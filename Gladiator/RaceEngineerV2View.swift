...
struct RaceEngineerV2View: View {
    ...
    private var resultSection: some View {
        ...
        case .none:
            EmptyView()
        case .success(let r):
            RaceEngineerV2ResultCard(result: r)
...
private struct RaceEngineerV2ResultCard: View {
...
private struct RaceEngineerV2FieldPicker: View {
    @Environment(\.dismiss) private var dismiss
    let title: String
